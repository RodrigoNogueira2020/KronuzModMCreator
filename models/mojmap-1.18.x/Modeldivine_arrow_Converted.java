...
public class Modeldivine_arrow_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "divine_arrow_converted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -5.0F, 0.0F, 16.0F, 5.0F, 0.0F,
		...
		PartDefinition body_r2 = body
				.addOrReplaceChild("body_r2",
						CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -5.0F, 0.0F, 16.0F, 5.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.0F, 1.5708F, 0.0F));
