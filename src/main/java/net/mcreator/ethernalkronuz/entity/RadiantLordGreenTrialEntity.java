...
public class RadiantLordGreenTrialEntity extends Monster implements RangedAttackMob, IAnimatable {
	...
	public RadiantLordGreenTrialEntity(EntityType<RadiantLordGreenTrialEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "rl_crystal_green");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 80) {
			this.remove(RadiantLordGreenTrialEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
