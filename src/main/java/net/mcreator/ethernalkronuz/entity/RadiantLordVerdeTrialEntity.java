...
public class RadiantLordVerdeTrialEntity extends Monster {
	...
	public RadiantLordVerdeTrialEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EthernalKronuzModEntities.RADIANT_LORD_VERDE_TRIAL.get(), world);
	}

	public RadiantLordVerdeTrialEntity(EntityType<RadiantLordVerdeTrialEntity> type, Level world) {
		super(type, world);
		xpReward = 500;
		setNoAi(false);
