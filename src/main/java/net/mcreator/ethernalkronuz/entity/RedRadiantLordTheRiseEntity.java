...
public class RedRadiantLordTheRiseEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RedRadiantLordTheRiseEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RedRadiantLordTheRiseEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RedRadiantLordTheRiseEntity.class, EntityDataSerializers.STRING);
	...
	public RedRadiantLordTheRiseEntity(EntityType<RedRadiantLordTheRiseEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		RedRadiantLordTheRiseEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata, tag);
		RedRadiantLordTheRiseOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RedRadiantLordTheRiseEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
