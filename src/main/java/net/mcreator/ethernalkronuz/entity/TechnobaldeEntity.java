...
public class TechnobaldeEntity extends PathfinderMob {
	public TechnobaldeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EthernalKronuzModEntities.TECHNOBALDE.get(), world);
	}

	public TechnobaldeEntity(EntityType<TechnobaldeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TechnobaldeRightClickedOnEntityOpenGUIProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
