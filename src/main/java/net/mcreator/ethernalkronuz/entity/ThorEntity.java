...
public class ThorEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ThorEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ThorEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ThorEntity.class, EntityDataSerializers.STRING);
	...
	public ThorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EthernalKronuzModEntities.THOR.get(), world);
	}

	public ThorEntity(EntityType<ThorEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("§l§cThor"));
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ThorEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
