...
import net.mcreator.ethernalkronuz.client.renderer.RadiantLordVerdeTrialRenderer;
...
public class EthernalKronuzModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(EthernalKronuzModEntities.RADIANT_LORD_VERDE_TRIAL.get(), RadiantLordVerdeTrialRenderer::new);
