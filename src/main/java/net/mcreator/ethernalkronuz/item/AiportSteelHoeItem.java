...
public class AiportSteelHoeItem extends HoeItem {
	public AiportSteelHoeItem() {
		super(new Tier() {
			public int getUses() {
				return 16256;
			}
		...
		}, 0, 3f, new Item.Properties().tab(EthernalKronuzModTabs.TAB_CREATIVE_TAB).fireResistant());
	}
}
