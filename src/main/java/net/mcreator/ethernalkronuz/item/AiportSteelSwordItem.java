...
public class AiportSteelSwordItem extends SwordItem {
	public AiportSteelSwordItem() {
		super(new Tier() {
			public int getUses() {
				return 16256;
			}
		...
		}, 3, -2.8f, new Item.Properties().tab(EthernalKronuzModTabs.TAB_CREATIVE_TAB).fireResistant());
	}
}
