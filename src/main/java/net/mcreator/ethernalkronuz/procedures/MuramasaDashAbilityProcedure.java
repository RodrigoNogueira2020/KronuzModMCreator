	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (entity.isShiftKeyDown() || !entity.isCrouching()) {
			...
			if (world instanceof ServerLevel _level)
				_level.playSound(null, entity.getX(), entity.getY(), entity.getZ(), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(soundEvent)), SoundSource.PLAYERS, 1.0f, 1.0f);
