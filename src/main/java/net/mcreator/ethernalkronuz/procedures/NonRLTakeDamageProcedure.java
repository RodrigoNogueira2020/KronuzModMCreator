...
public class NonRLTakeDamageProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!(((entity.getCapability(EthernalKronuzModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new EthernalKronuzModVariables.PlayerVariables())).RadiantLordRoxoPlayer
				...
				&& (entity.getCapability(EthernalKronuzModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new EthernalKronuzModVariables.PlayerVariables())).AllowInJotunheim)) {
			new Object() {
				private int ticks = 0;
				...
				private void run() {
					if (entity instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("jotunheimDamage").bypassArmor(), (float) Double.POSITIVE_INFINITY);
