...
public class PassRadiantLordRoxoToPlayerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (!(entity == (new Object() {
		...
		}.getEntity())) && (entity.getCapability(EthernalKronuzModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new EthernalKronuzModVariables.PlayerVariables())).RadiantLordRoxoPlayer) {
			...
			if (!world.isClientSide()) {
				...
				if (_mcserv != null)
					_mcserv.getPlayerList().broadcastMessage(new TextComponent((ForgeRegistries.ENTITIES.getKey(entity.getType()).toString() + " passou os poderes a " + ForgeRegistries.ENTITIES.getKey((new Object() {
						public Entity getEntity() {
							try {
								return EntityArgument.getEntity(arguments, "name");
							} catch (CommandSyntaxException e) {
					...
					}.getEntity()).getType()).toString())), ChatType.SYSTEM, Util.NIL_UUID);
			}
		}
	}
}
