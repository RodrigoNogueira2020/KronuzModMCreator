...
public class RLRoxoTransformationProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if ((entity.getCapability(EthernalKronuzModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new EthernalKronuzModVariables.PlayerVariables())).RadiantLordRoxoPlayer && (entity instanceof Player || entity instanceof ServerPlayer)) {
			if (_evt.getRenderer() instanceof PlayerRenderer) {
				if (_evt instanceof RenderLivingEvent.Pre) {
					_evt.setCanceled(true);
				}
				new com.kleiders.kleidersplayerrenderer.KleidersPlayerRenderer(context, new ResourceLocation("ethernal_kronuz:textures/entities/rl_crystal_purple.png"), new Modelradiantlord(context.bakeLayer(Modelradiantlord.LAYER_LOCATION)))
