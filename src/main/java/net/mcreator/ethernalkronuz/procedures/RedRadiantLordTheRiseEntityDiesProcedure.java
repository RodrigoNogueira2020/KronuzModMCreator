...
public class RedRadiantLordTheRiseEntityDiesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof RedRadiantLordTheRiseEntity && (sourceentity instanceof ServerPlayer || sourceentity instanceof Player)) {
