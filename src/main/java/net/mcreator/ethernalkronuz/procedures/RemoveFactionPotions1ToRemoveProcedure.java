...
public class RemoveFactionPotions1ToRemoveProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		}.getEntity()) instanceof LivingEntity _livEnt ? _livEnt.hasEffect(EthernalKronuzModMobEffects.BT_EFFECT.get()) : false) {
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
		...
		}.getEntity()) instanceof LivingEntity _livEnt ? _livEnt.hasEffect(MobEffects.LUCK) : false) {
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
		...
		}.getEntity()) instanceof LivingEntity _livEnt ? _livEnt.hasEffect(MobEffects.SLOW_FALLING) : false) {
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
		...
		}.getEntity()) instanceof LivingEntity _livEnt ? _livEnt.hasEffect(MobEffects.REGENERATION) : false) {
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
