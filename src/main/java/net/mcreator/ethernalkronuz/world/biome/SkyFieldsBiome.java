...
public class SkyFieldsBiome {
	public static Biome createBiome() {
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.NONE).temperature(0.8f).downfall(0f).specialEffects(effects).mobSpawnSettings(mobSpawnInfo.build())
