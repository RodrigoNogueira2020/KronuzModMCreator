...
public class AesirPortalStructureFeature extends Feature<NoneFeatureConfiguration> {
	public static AesirPortalStructureFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AesirPortalStructureFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:aesir_portal_structure", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:aesir_portal_structure", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public AesirPortalStructureFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ethernal_kronuz", "aesir_portal_pilar"));
		if (template == null)
			return false;
