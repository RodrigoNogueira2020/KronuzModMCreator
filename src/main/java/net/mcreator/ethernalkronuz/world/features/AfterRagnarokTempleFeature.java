...
public class AfterRagnarokTempleFeature extends Feature<NoneFeatureConfiguration> {
	public static AfterRagnarokTempleFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AfterRagnarokTempleFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:after_ragnarok_temple", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:after_ragnarok_temple", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public AfterRagnarokTempleFeature() {
