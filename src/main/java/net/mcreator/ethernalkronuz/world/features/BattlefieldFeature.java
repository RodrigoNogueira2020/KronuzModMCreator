...
public class BattlefieldFeature extends Feature<NoneFeatureConfiguration> {
	public static BattlefieldFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BattlefieldFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:battlefield", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:battlefield", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
