...
public class TheRiseChamberPurpleFeature extends Feature<NoneFeatureConfiguration> {
	public static TheRiseChamberPurpleFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TheRiseChamberPurpleFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:the_rise_chamber_purple", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:the_rise_chamber_purple", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TheRiseChamberPurpleFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ethernal_kronuz", "green_trial"));
		if (template == null)
			return false;
