...
public class TheRiseChamberRedFeature extends Feature<NoneFeatureConfiguration> {
	public static TheRiseChamberRedFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TheRiseChamberRedFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:the_rise_chamber_red", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:the_rise_chamber_red", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TheRiseChamberRedFeature() {
