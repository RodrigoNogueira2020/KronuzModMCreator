...
public class YggbigbushSkyFieldsFeature extends Feature<NoneFeatureConfiguration> {
	public static YggbigbushSkyFieldsFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new YggbigbushSkyFieldsFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:yggbigbush_sky_fields", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:yggbigbush_sky_fields", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public YggbigbushSkyFieldsFeature() {
