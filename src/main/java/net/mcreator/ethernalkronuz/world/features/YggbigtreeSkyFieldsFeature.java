...
public class YggbigtreeSkyFieldsFeature extends Feature<NoneFeatureConfiguration> {
	public static YggbigtreeSkyFieldsFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new YggbigtreeSkyFieldsFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:yggbigtree_sky_fields", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:yggbigtree_sky_fields", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public YggbigtreeSkyFieldsFeature() {
