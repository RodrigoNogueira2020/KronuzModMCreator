...
public class YggmediumtreeFloatingGardenFeature extends Feature<NoneFeatureConfiguration> {
	public static YggmediumtreeFloatingGardenFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new YggmediumtreeFloatingGardenFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:yggmediumtree_floating_garden", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:yggmediumtree_floating_garden", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public YggmediumtreeFloatingGardenFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ethernal_kronuz", "ygg_medium_tree"));
		if (template == null)
			return false;
