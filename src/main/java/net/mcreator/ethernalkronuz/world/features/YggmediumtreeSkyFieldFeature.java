...
public class YggmediumtreeSkyFieldFeature extends Feature<NoneFeatureConfiguration> {
	public static YggmediumtreeSkyFieldFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new YggmediumtreeSkyFieldFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ethernal_kronuz:yggmediumtree_sky_field", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ethernal_kronuz:yggmediumtree_sky_field", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public YggmediumtreeSkyFieldFeature() {
